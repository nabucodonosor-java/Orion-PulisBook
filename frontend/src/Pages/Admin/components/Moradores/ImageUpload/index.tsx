...
import { ReactComponent as UploadPlaceHolder} from 'core/assests/images/upload-placeholder.svg';
import './styles.scss';

type Props = {
    onUploadSuccess: (imgUrl: string) => void;
    moradorImgUrl: string;
}

const ImageUpload = ({ onUploadSuccess, moradorImgUrl }: Props) => {
    const [uploadProgress, setUploadProgress] = useState(0);
    const [uploadedImgUrl, setUploadedImgUrl] = useState('');
    const imgUrl = uploadedImgUrl || moradorImgUrl;
