                ...
                <div className="row">
                    <div className="col-6 pr-5">
                        {isLoading ? <MoradorInfoLoader /> : (
                            <>
                            <div className="morador-details-card text-center">
                    ...
                    <div className="col-6 card-base border-radius-20 morador-details-info">
                        {isLoading ? <MoradorDescriptionLoader /> : (
                              ...
                              <div className="mb-2">
                                <h6 className="morador-details-info-title">Ano de Entrada na Faculdade</h6>
                                {morador?.anoEntradaFaculdade}
                              </div>
                              <div className="mb-2">
